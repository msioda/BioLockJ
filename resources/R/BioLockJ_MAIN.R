...
importTemplate <- function() {
	source( file.path( dirname( getModuleScript() ), templateName() ) )
}
...
runModule <- function()
{
	...
	if( !init( templateName() ) ) stop( paste( errMsg, "templateName()" ) )
