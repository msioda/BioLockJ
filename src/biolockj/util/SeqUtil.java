...
public class SeqUtil {
    ...
    protected static void initSeqParams() throws Exception {
        ...
        for( final File f: BioLockJUtil.getPipelineInputFiles() ) {
            ...
            try {
                ...
                if( headerChar == null ) throw new Exception( "Failed to to identify 1st character of sequence header in: " + f.getAbsolutePath() );
        ...
        if( foundFasta != null && foundFastq != null ) 
            throw new ConfigFormatException( Constants.INTERNAL_SEQ_TYPE, "Input files from: " + Constants.INPUT_DIRS
            + " must all be of a single type (FASTA or FASTQ)." + Constants.RETURN + "FASTA file found: " + foundFasta
            + Constants.RETURN + "FASTQ file found: " + foundFastq );
        ...
        String configSeqType = Config.getString( null, Constants.INTERNAL_SEQ_TYPE );
    ...
    private static void setSeqType( String type ) {
