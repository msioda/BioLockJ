...
public class NextflowUtil {
    ...
    {
        String s3 = Config.requireString( null, AWS_S3 ) + File.separator + Config.pipelineName();
    ...
    private static String getNextflowDir() {
    		File f = new File( Config.pipelinePath() + File.separator + NEXTFLOW_CMD );
    		if( !f.exists() ) f.mkdir();
    ...
    private static void startService() throws Exception {
        ...
        args[ 1 ] = "run";
        args[ 2 ] = "-work-dir";
        args[ 3 ] = S3_DIR + Config.requireString( null, AWS_S3 ) + File.separator + Config.pipelineName() + File.separator + NEXTFLOW_CMD;
        args[ 4 ] = "-with-trace";
    ...
    /**
     * {@link biolockj.Config} Boolean property: If enabled delete all EFS dirs (except pipelines): {@value #AWS_PURGE_EFS_INPUTS}
     */
