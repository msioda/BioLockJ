...
public class RdpNode extends OtuNodeImpl implements OtuNode {
    ...
    private Integer calculateScore( String scoreString ) throws Exception {
        if( scoreString.equals( "1" ) || scoreString.equals( "1.0" ) ) return 100;
        else if( scoreString.equals( "0" ) || scoreString.equals( "0.0" ) ) return 0;
        else if( !scoreString.startsWith( "0." ) ) throw new Exception( rangeError( scoreString ) );
        ...
        if( thisScore < 0 || thisScore > 100 ) throw new Exception( rangeError( scoreString ) );
