...
public abstract class R_Module extends ScriptModuleImpl {
	...
	public void checkColorFile() throws ConfigPathException, IOException, ConfigViolationException {
		...
		if( !( colorFile == null ) ) {
			final BufferedReader br = new BufferedReader( new FileReader( colorFile ) );
			final String[] header = br.readLine().split( Constants.TAB_DELIM );
			br.close();
			if( !header[ 0 ].equals( "key" ) || !header[ 1 ].equals( "color" ) ) throw new ConfigViolationException(
				R_COLOR_FILE,
